  ...
  return (
    <>
      <div className="fixed z-10 flex flex-row items-center justify-between w-full px-4 py-2 mx-auto text-white bg-black 2xl:text-lg md:px-8 2xl:px-20 flex-nowrap">
        <div>
          <Link to="/">
            <img className="object-scale-down h-20 w-24" src={Logo} alt="WIL Logo"/>
            </Link>
          </div>
        {currentUser ? (
          <>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button className="py-2 rounded shadow-lg hover:text-white bg-yellow lg:px-4 md:px-2 hover:bg-amber-300">
